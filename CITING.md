...
# Cite the Research Initiative

Use this when referring to the overall body of work.
...
# Cite an Individual Article

When citing a specific article, please reference both the article title and the project.
...
When referencing a framework (for example, ASSET-grade or the Governed Decision Layer), please cite the article or document in which the framework is defined.
...
If concepts from this repository influence standards documents, industry guidance, architecture documents, internal design documents, or technical specifications, please cite the originating article or framework whenever practical.

---

# Presentations and Training

If this material is used in presentations, workshops, university courses, certification programs, or internal corporate training, attribution should be included on the relevant slide or course material.
...
Unless otherwise noted, written content in this repository is licensed under the Creative Commons Attribution 4.0 International (CC BY 4.0) License.
...
Suggestions, corrections, and discussions are welcome through GitHub Discussions or GitHub Issues.

If you are building upon these ideas in research or industrial practice, I would be delighted to hear from you.
